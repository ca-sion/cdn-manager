...
class ProvisionElementExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('vip_response_status_cross')->state(function (Model $record): ?string {
                return ($record->vip_response_status == 1 || $record->vip_response_status == true || $record->vip_response_status) ? 'x' : null;
            }),
